...
| 真机验证                | L3             | L3                                           | L3                          | L3                          |
| 当前分发来源            | 仓库（已公开） | GitHub Release `v0.3.5` ZIP                  | GitHub Release `v0.3.5` ZIP | GitHub Release `v0.3.5` ZIP |
...
| Qoder     | GitHub Release `v0.3.5` ZIP | full     | release-asset |
| WorkBuddy | GitHub Release `v0.3.5` ZIP | full     | release-asset |
| 豆包      | GitHub Release `v0.3.5` ZIP | full     | release-asset |
