 ...
 * It is currently `v0.3.5`. CANDIDATE_* describes the NEXT unpublished build produced by
 * `package:hosts`.
...
export const PUBLISHED_RELEASE_VERSION: string | null = '0.3.5';
/** Immutable tag for the published Release. */
export const PUBLISHED_RELEASE_TAG: string | null = 'v0.3.5';
