 ...
 * It is currently `v0.3.0`. CANDIDATE_* describes the NEXT unpublished build produced by
 * `package:hosts`.
...
export const ROOT_ENGINE_VERSION = '0.3.0';
/** The published Release currently reflected by the root manifest. */
export const PUBLISHED_RELEASE_VERSION: string | null = '0.3.0';
/** Immutable tag for the published Release. */
export const PUBLISHED_RELEASE_TAG: string | null = 'v0.3.0';
